...
bedroom_door.addEventListener('click', function () {
    if (chains.style.visibility == "hidden") {
        ...
        alert("There's a chain around the door, I have to find a way to break it");
    }
});
...
closet_open.addEventListener('click', function () {
    alert("There is a jacket inside");
});
jacket.addEventListener('click', function () {
    alert("A nice warm jacket");
});
key_inv.addEventListener('click', function () {
    alert("A small key, I wonder what it unlocks");
});
crowbar_inv.addEventListener('click', function () {
    alert("Very useful tool, it's good for breaking things");
});
...
chest_open.addEventListener('click', function () {
    alert("Better search inside");
});
picture.addEventListener('click', function () {
    alert("A cute looking picture");
});
...
window_left.addEventListener('click', function () {
    alert("The windows are dirty, it's hard to see outside");
});
...
trash.addEventListener('click', function () {
    alert("A trash can, maybe I can find something useful in here");
});
...
bulb_inv.addEventListener('click', function () {
    alert("A lightbulb, I wonder if it still works");
});
...
battery_inv.addEventListener('click', function () {
    alert("A car battery, I hope it's charged");
});
tire1.addEventListener('click', function () {
    alert("Tires, tires, tires");
});
...
cables_inv.addEventListener('click', function () {
    alert("Jumper cables, can be used to connect something");
});
...
fridge_open.addEventListener('click', function () {
    alert("Looks like the fridge is empty");
});
...
washer.addEventListener('click', function () {
    alert("A washing machine, it doesn't appear to be working");
});
hole.addEventListener('click', function () {
    ...
    if (hole.style.cursor == "pointer") {
        ...
        alert("I could try to climb down if I had the right equipment");
    }
...
hook_inv.addEventListener('click', function () {
    alert("A hook made of steel");
});
rope_inv.addEventListener('click', function () {
    alert("The rope looks strong and long");
});
...
spider.addEventListener('click', function () {
    if (knife == true) {
        ...
        alert("There is a huge spider, I wonder if I can get past it somehow");
    }
...
mask_inv.addEventListener('click', function () {
    alert("A diving mask, I can go underwater now");
});
...
water.addEventListener('click', function () {
    ...
    if (mask == true) {
        ...
        alert("I'm not going in water without the right equipment");
    }
...
harpoon_inv.addEventListener('click', function () {
    alert("Somebody lost a harpoon gun down here, can be used to defend against large fish");
});
plants.addEventListener('click', function () {
    alert("Underwater plants, pretty common around here");
});
...
shark.addEventListener('click', function () {
    ...
    if (harpoon == true) {
        ...
        alert("Wow, that's a huge shark, I have nothing to defend me if I get attacked");
    }
...
paddle_inv.addEventListener('click', function () {
    alert("A wooden paddle, very strong, can be used to push something");
});
rocks.addEventListener('click', function () {
    if (paddle == true) {
        rocks.style.cursor = "pointer";
    } else {
        alert("A huge pile of rocks is blocking the way, I wonder if I can move it with something");
    }
...
police.addEventListener('click', function () {
    ...
    alert("Hey little girl, how did you get here?");
    alert("Everyone's been looking for you");
    alert("Come with us, we'll take you to your parents");
});
